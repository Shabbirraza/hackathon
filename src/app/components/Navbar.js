...
const Navbar = ({ username, pathname, userId }) => {
  ...
  return (
    <div className='w-full bg-purple-900 pr-[30px] pl-[20px] md:pl-[70px] pb-[10px] pt-[10px] flex flex-col  items-center justify-center gap-5 md:flex-row md:justify-between'>
